...
class EnrollmentNoteControllerTest extends TestCase
{
    ...
    public function test_store_ITcoach_TOEIC(): void
    {
        $this->seed();
        $student = User::where('email', 'student@certify-lms.test')->firstOrFail();
        ...
        public function test_store_ITcoach_basic(): void
    {
        $this->seed();
        $student = User::where('email', 'student@certify-lms.test')->firstOrFail();
        $ITCoach = User::where('email', 'coach@certify-lms.test')->firstOrFail();
        ...
        public function test_store_businessCoach_boki(): void
    {
        $this->seed();
        $student = User::where('email', 'student@certify-lms.test')->firstOrFail();
    ...
    public function test_edit_ITcoach(): void
    {
        $this->seed();
    ...
    public function test_edit_businessCoach(): void
    {
        $this->seed();
    ...
    public function test_update_ITcoach(): void
    {
        $this->seed();
        ...
        public function test_update_businesscoach(): void
    {
        ...
        public function test_delete_ITcoach(): void
    {
        $this->seed();
