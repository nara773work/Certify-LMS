...
class QaThreadSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        QaThread::create([
            ...
            'body' => 'INNER JOINを使ったSQLの書き方が苦手です。
                        テーブルを結合する考え方は分かるのですが、問題文からSQLを書くのが難しいです。
                        基本的な考え方や練習方法があれば教えてください。',
        ...
        QaThread::create([
            ...
            'body' => '応用情報技術者試験の勉強を始めましたが、午後問題の対策方法が分かりません。
                        午前問題は過去問を繰り返し解いていますが、午後問題は文章量が多く、
                        どこから読み始めればよいのか迷ってしまいます。
                        また、記述式の解答にも慣れておらず、模範解答を見ても「なぜその答えになるのか」が理解できないことがあります。
                        過去問を何年分くらい解けばよいのか、
                        効率的な勉強方法やおすすめの進め方があれば教えていただきたいです。',
            'status' => QaThreadStatus::UnResolved,
        ]);
        ...
        QaThread::create([
            ...
            'body' => 'PMPの勉強を始めてまだ日が浅く、現在はプロジェクトスコープマネジメントの分野を中心に学習しています。
                        ...
                        しかし、どのレベルまで作業を分解すれば十分なのかが分からず、細かくしすぎても管理が大変になりそうですし、
                        逆に大まかすぎると進捗管理が難しくなってしまうように感じています。
                        例えば、システム開発プロジェクトを例にすると、「要件定義」「基本設計」「詳細設計」「実装」「テスト」といったレベルで止めるべきなのか、
                        それとも「ログイン画面作成」「会員登録API作成」「単体テスト」「結合テスト」など、さらに細かい単位まで分解するべきなのか判断できません。
                        ...
                        現在は市販の参考書と問題集を使って学習していますが、知識を暗記するだけでは限界があると感じています。実際に架空のプロジェクトを題材にWBSを作ってみる練習をした方が良いのか、
                        それとも試験対策としては過去問を繰り返し解く方が効率的なのでしょうか。
                        もしおすすめの教材や、初心者向けの演習方法、理解しやすい動画などがあれば教えていただきたいです。
                        実務でプロジェクトマネージャーやリーダーを経験された方がいらっしゃれば、WBSを作成するときに意識しているポイントや、作業を分解する際の判断基準、
                        初心者が陥りやすい失敗例なども教えていただけると嬉しいです。また、PMP試験の学習を進めるうえで、
                        WBSを効率よく理解するための勉強方法や、おすすめの順番があればぜひ参考にしたいと考えています。よろしくお願いいたします。',
            'status' => QaThreadStatus::Resolved,
        ]);
        ...
        QaThread::create([
            ...
            'title' => '応用情報との違いは何ですか？',
            'body' => '基本情報の勉強を進めています。
                        試験範囲を見ると応用情報と重なる内容も多いように感じるのですが、難易度や学習内容はどのくらい違うのでしょうか。
                        基本情報合格後は応用情報も受験する予定なので、勉強の進め方についてアドバイスをいただきたいです。',
            'status' => QaThreadStatus::Resolved,
        ]);
